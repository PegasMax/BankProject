...
def test_convert_amount_to_rub_usd(coll_usd_transaction: dict):
    ...
    with patch("requests.get") as mock_get:
        ...
        mock_get.return_value.json.return_value ='{"date": "2018-02-22", "historical": "", "info": {"rate": 148.972231, "timestamp": 1519328414}, "query": {"amount": 25, "from": "GBP", "to": "JPY"}, "result": 3724.305775, "success": true}'
