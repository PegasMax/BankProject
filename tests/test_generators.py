...
def test_filter_by_currency_basic(call_transactions_list: dict):
    ...
    assert list(filter_by_currency(call_transactions_list["all_transactions"], "USD")) == call_transactions_list["USD_transactions"]

    assert list(filter_by_currency(call_transactions_list["all_transactions"], "RUB")) == call_transactions_list["RUB_transactions"]
...
def test_transaction_descriptions_basic(call_transactions_list: dict):
    ...
    assert list(transaction_descriptions(call_transactions_list["all_transactions"])) == call_transactions_list["all_transactions_descriptions"]
...
@pytest.mark.parametrize(
    "start_number, finish_number, expected_result",
        [(2200404533221000,
        2200404533221010,
        ["2200 4045 3322 1000", "2200 4045 3322 1001", "2200 4045 3322 1002", "2200 4045 3322 1003", "2200 4045 3322 1004", "2200 4045 3322 1005", "2200 4045 3322 1006",
         "2200 4045 3322 1007", "2200 4045 3322 1008", "2200 4045 3322 1009", "2200 4045 3322 1010"]
        ),
        (
        1,
        2,
